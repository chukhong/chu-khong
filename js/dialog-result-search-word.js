...
var eventReceiver = {
    ...
    getMeaning: function (data) {
        ...
        // if(!data.append)
        //     d.id('meanningShow').innerHTML = tmp
        var innerHTML = meanningShow.innerHTML
        meanningShow.innerHTML = data.append ? innerHTML + tmp : tmp
        //searchUserDict($('#search-input').val().trim())
        searchUserDict(searchInput.value.trim())
    },
...
var dialogResultSearchWord = function (d, editor, parentNode, ref) {
    ...
    var fns = {
        formSubmit: (evt) => {
            ...
            var key = searchInput.value.trim()
...
}).call(dialogResultSearchWord.prototype);
exports.dialogResultSearchWord = dialogResultSearchWord